/*
 * This is based on a portable snprintf implementation available at:
...
#elif !defined(__ORCAC__) /* By default, we assume a modern system for testing. */
	...
	while (ch != '\0')
		...
		case PRINT_S_CONV:
			...
			case 'g':
				...
				/* FALLTHROUGH */
			case 'f':
				if (__ORCAC__ || cflags == PRINT_C_LDOUBLE)
